...
const ProjectsPage = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-[--color-bg-surface] py-20 md:py-28">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_rgba(59,79,224,0.08),_transparent_35%)]" />

      <div className="relative mx-auto max-w-7xl px-6 md:px-8">
        <div className="mb-16">
          <SectionLabel>PROYECTOS</SectionLabel>
          <SectionTitle>Soluciones que impulsan negocios</SectionTitle>
        </div>
